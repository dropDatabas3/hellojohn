...
import {
  ...
  ArrowRight, Sparkles, AlertTriangle, ChevronDown
} from "lucide-react"
      ...
      <div className="space-y-6 animate-in fade-in duration-500">
        ...
        <div className="flex items-center gap-4">
          <Button
            variant="ghost"
            size="sm"
            onClick={() => router.push(tenantId ? `/admin/tenants/detail?id=${tenantId}` : "/admin/tenants")}
            className="gap-2"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                {tenant?.name || "Global"} • Configura la autenticación con proveedores externos
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Info Banner */}
        <Alert className="border-blue-500/20 bg-gradient-to-r from-blue-500/10 to-indigo-500/5">
          <Info className="h-4 w-4 text-blue-400" />
          <AlertTitle className="text-blue-300">¿Qué son los Proveedores Sociales?</AlertTitle>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <StatCard
            ...
            icon={AlertCircle}
            color={stats.errors30d > 0 ? "amber" : "default"}
          />
        </div>
                ...
                {providers?.map((provider) => (
                  <Card
                    ...
                    className={cn(
                      ...
                      provider.enabled && "border-l-2 border-l-emerald-500/50"
                    )}
                  >
                    <Collapsible
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Button
                              ...
                              className={cn(
                                "gap-2",
                                !provider.enabled && "bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600"
                              )}
                            >
                  ...
                  <div>
                    ...
                    <div className="mt-3 p-3 rounded-lg bg-white/[0.03] border border-white/[0.06]">
                      ...
                      <p className="text-xs text-muted-foreground mt-2">
                        Reemplaza <code className="text-amber-400">{'{provider}'}</code> con: google, github, microsoft, etc.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {!testResult ? (
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="text-center">
                    <p className={cn("font-medium", testResult.success ? "text-emerald-400" : "text-red-400")}>
