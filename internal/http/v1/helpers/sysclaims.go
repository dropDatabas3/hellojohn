...
// V1 (Fase 1): solo is_admin y placeholders.
...
// V2 (Fase 2): roles/perms efectivos + claims_ver=1.
// Si roles/perms vienen vacíos, se preserva el comportamiento de V1 (pero sube claims_ver).
